 ...
 * @author ariramadhan
 */
public class Tbl_BarangForm extends javax.swing.JFrame {
    ...
    public Tbl_BarangForm(int IdBarang, String namaBarang) {
        initComponents();
    ...
    private void txtCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyReleased
        ...
        if(!txtCari.getText().equals("")){
            res = bd.SearchBarang(txtCari.getText());
            tbl.SetTabel(jTable1, res, namaKolom, jmlKolom, lebar);
        }else{
            res = bd.ShowDataBarang();
            tbl.SetTabel(jTable1, res, namaKolom, jmlKolom, lebar);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        tb_barang.setIdBarang(Integer.parseInt(jTable1.getValueAt(row, 0).toString()));
        tb_barang.setNamaBarang(jTable1.getValueAt(row, 1).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tbl_BarangForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tbl_BarangForm(tb_barang.getIdBarang(), tb_barang.getNamaBarang()).setVisible(true);
            }
        });
    }
