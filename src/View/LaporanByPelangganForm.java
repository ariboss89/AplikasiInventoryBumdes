 ...
 * @author ariramadhan
 */
public class LaporanByPelangganForm extends javax.swing.JFrame {
...
//    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("LIST PELANGGAN");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtPelanggan, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtPelanggan.getText().equals("")) {
            ...
            rd.CetakLaporanPelanggan(txtPelanggan.getText(), tglAwal, tglAkhir);
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        new Tbl_Pelanggan(tb_pelanggan.getIdPelanggan(), tb_pelanggan.getNama()).show();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        // TODO add your handling code here:

        int idku = tb_pelanggan.getIdPelanggan();

        if (tb_pelanggan.getIdPelanggan() != 0) {
            txtPelanggan.setText(tb_pelanggan.getNama());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanByPelangganForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new LaporanByPelangganForm().setVisible(true);
            }
        });
    }
